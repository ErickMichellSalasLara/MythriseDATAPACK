...
scoreboard players add @s toxic_timer 1
execute if score @s toxic_timer matches 60.. at @s run playsound minecraft:entity.player.hurt_drown player @s ~ ~ ~ 0.6 0.7
execute if score @s toxic_timer matches 60.. run scoreboard players set @s toxic_timer 0
