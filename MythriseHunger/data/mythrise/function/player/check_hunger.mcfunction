...
# Jugadores con hambre baja (7 de comida visual o menos) -> aplicar efectos negativos
execute as @a[scores={mythrise_food=..14}] at @s run function mythrise:player/starving
